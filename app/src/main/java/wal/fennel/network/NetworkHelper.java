...
//    public static final String CLIENT_SECRET = "2913726762900040703";
    ...
    public static final String QUERY_TASK_ITEM_ATTACHMENTS = "SELECT Id, File_Type__c, (SELECT Id, ParentId, Name, Description FROM Attachments) FROM Task_Item__c WHERE Id IN (%s)";
