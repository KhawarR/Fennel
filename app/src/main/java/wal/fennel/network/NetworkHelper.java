...
//    public static final String GET_FARMER_TASK_ITEMS = "Select t.Text_Value__c, t.Sequence__c, t.RecordType.Name, t.RecordTypeId, t.Name, t.Location__c, t.Location__Longitude__s, t.Location__Latitude__s, t.GPS_Taken_Time__c, t.File_Type__c, t.Farming_Task__c, t.Description__c, (Select Name, Value__c From Task_Item_Options__r) From Task_Item__c t WHERE Farming_Task__c = '%s' order by Sequence__c";
    ...
    public static final String GET_MY_DASHBOARD_DATA_FIELD_MANAGER = "Select f.Status__c, f.Started_Date__c, f.Shamba__c, f.Shamba__r.Farmer_Phone__c, f.Shamba__r.Facilitator_Signup__r.Id, f.Shamba__r.Facilitator_Signup__r.Name, f.Shamba__r.Facilitator_Signup__r.Phone__c, f.Shamba__r.Facilitator_Signup__r.Employee_ID__c, f.Shamba__r.Field_Officer_Signup__r.Id, f.Shamba__r.Field_Officer_Signup__r.Name, f.Shamba__r.Field_Officer_Signup__r.Phone__c, f.Shamba__r.Field_Officer_Signup__r.Employee__r.Name, f.Shamba__r.Field_Manager_Signup__r.Id, f.Shamba__r.Field_Manager_Signup__r.Name, f.Shamba__r.Field_Manager_Signup__r.Employee__r.Name, f.Shamba__r.Sign_Up_Status__c, f.Name, f.Id, f.Farmer__c, f.Due_Date__c, f.Completion_Date__c From Farming_Task__c f WHERE f.Shamba__r.Field_Manager_Signup__c = '%s'";
    public static final String GET_MY_DASHBOARD_DATA_FIELD_OFFICER = "Select f.Status__c, f.Started_Date__c, f.Shamba__c, f.Shamba__r.Farmer_Phone__c, f.Shamba__r.Facilitator_Signup__r.Id, f.Shamba__r.Facilitator_Signup__r.Name, f.Shamba__r.Facilitator_Signup__r.Phone__c, f.Shamba__r.Facilitator_Signup__r.Employee_ID__c, f.Shamba__r.Field_Officer_Signup__r.Id, f.Shamba__r.Field_Officer_Signup__r.Name, f.Shamba__r.Field_Officer_Signup__r.Phone__c, f.Shamba__r.Field_Officer_Signup__r.Employee__r.Name, f.Shamba__r.Field_Manager_Signup__r.Id, f.Shamba__r.Field_Manager_Signup__r.Name, f.Shamba__r.Field_Manager_Signup__r.Employee__r.Name, f.Shamba__r.Sign_Up_Status__c, f.Name, f.Id, f.Farmer__c, f.Due_Date__c, f.Completion_Date__c From Farming_Task__c f WHERE f.Shamba__r.Field_Officer_Signup__c = '%s'";
    public static final String GET_MY_DASHBOARD_DATA_FACILITATOR = "Select f.Status__c, f.Started_Date__c, f.Shamba__c, f.Shamba__r.Farmer_Phone__c, f.Shamba__r.Facilitator_Signup__r.Id, f.Shamba__r.Facilitator_Signup__r.Name, f.Shamba__r.Facilitator_Signup__r.Phone__c, f.Shamba__r.Facilitator_Signup__r.Employee_ID__c, f.Shamba__r.Field_Officer_Signup__r.Id, f.Shamba__r.Field_Officer_Signup__r.Name, f.Shamba__r.Field_Officer_Signup__r.Phone__c, f.Shamba__r.Field_Officer_Signup__r.Employee__r.Name, f.Shamba__r.Field_Manager_Signup__r.Id, f.Shamba__r.Field_Manager_Signup__r.Name, f.Shamba__r.Field_Manager_Signup__r.Employee__r.Name, f.Shamba__r.Sign_Up_Status__c, f.Name, f.Id, f.Farmer__c, f.Due_Date__c, f.Completion_Date__c From Farming_Task__c f WHERE f.Shamba__r.Facilitator_Signup__c = '%s' Order by Due_Date__c, Name";
