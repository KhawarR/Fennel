package wal.fennel.location;

/**
 * Created by Khawar on 22/7/2016.
 */
        ...
        try {
            ...
            if (!isGPSEnabled && !isNetworkEnabled) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(mContext, "Location update failed, please check permissions", Toast.LENGTH_LONG).show();
                }
            }
